namespace MarkdownMode
{
    ...
    internal class MarkdownLanguageInfo : IVsLanguageInfo, IVsLanguageDebugInfo, IDisposable
    {
        ...
        private static readonly string[] FileExtensions = { ".mkd", ".md", ".mdown", ".mkdn", ".markdown" };
