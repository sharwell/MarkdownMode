namespace MarkdownMode.OptionsPages
{
    ...
    {
        private static readonly string ClientId = "21646e88c7006f9bbdbb";
        private static readonly string ClientSecret = "29c29fb3d1442e93a9a6b79496269b08d6c046e2";
        private static readonly string[] Scopes = { };

        private static readonly Uri BaseAddress = new Uri("https://github.com");
        private static readonly UriTemplate AuthorizationUriTemplate = new UriTemplate("login/oauth/authorize?client_id={client_id}&scope={scope}");
        private static readonly UriTemplate RequestTokenUriTemplate = new UriTemplate("/login/oauth/access_token?client_id={client_id}&client_secret={client_secret}&code={code}");
        ...
        private void CheckAuthorization(Uri uri)
        {
